...
require (
	...
	ocm.software/open-component-model/bindings/go/descriptor/runtime v0.0.0-20250714155011-0962c439cc10 // indirect
	ocm.software/open-component-model/bindings/go/descriptor/v2 v2.0.1-alpha3 // indirect
	ocm.software/open-component-model/bindings/go/oci v0.0.0-20250714155011-0962c439cc10 // indirect
